...
void main() {
  ...
  `,t.appendChild(a),t}function fv(){let e=[`Il tuo ristorante`,`La tua trattoria`,`La tua pizzeria`,`La tua caffetteria`],t=document.querySelector(`.hero-cycle-wrap`);if(!t)return;let n=t.querySelector(`.hero-cycle-word`),r=0,i=!1;function a(e){let t=document.createElement(`span`);t.style.cssText=`position:absolute;visibility:hidden;pointer-events:none;white-space:nowrap;`;let r=window.getComputedStyle(n);t.style.fontFamily=r.fontFamily,t.style.fontSize=r.fontSize,t.style.fontWeight=r.fontWeight,t.style.fontStyle=r.fontStyle,t.style.letterSpacing=r.letterSpacing,t.textContent=e,document.body.appendChild(t);let i=t.getBoundingClientRect().width;return document.body.removeChild(t),i}setTimeout(()=>{let n=a(e[0]);t.style.width=n+`px`},100),setTimeout(()=>{setInterval(()=>{if(i)return;i=!0;let o=(r+1)%e.length;n.classList.add(`hero-word-out`),setTimeout(()=>{r=o,n.textContent=e[r],n.classList.remove(`hero-word-out`),n.classList.add(`hero-word-in`);let s=a(e[r]);t.style.width=s+`px`,setTimeout(()=>{n.classList.remove(`hero-word-in`),i=!1},400)},300)},3e3)},2500)}q.registerPlugin(Y,oc,Tc),Y.config({ignoreMobileResize:!0}),window.addEventListener(`load`,()=>{document.fonts&&document.fonts.ready?document.fonts.ready.then(()=>Y.refresh()):setTimeout(()=>Y.refresh(),800)});function pv(){document.querySelectorAll(`[data-scroll-reveal]`).forEach(e=>{let t=e.getBoundingClientRect();t.top<window.innerHeight*1.1&&t.bottom>0&&parseFloat(getComputedStyle(e).opacity)<.1&&q.to(e,{opacity:1,y:0,duration:.5,overwrite:`auto`})})}setTimeout(pv,3e3);var mv=!1;window.addEventListener(`scroll`,()=>{mv||(mv=!0,requestAnimationFrame(()=>{mv=!1,pv()}))},{passive:!0});var hv=[{id:1,name:`Parrucchiera Debora`,description:`Salone di parrucchiera`,url:`http://parrucchieriadebora.it`,image:`/assets/images/portfolio/parrucchieriadebora.webp`,active:!0},{id:2,name:`Bottega del Mercato`,description:`Gastronomia e prodotti locali`,url:`https://robertogrilli.github.io/portfolio2-bottega-del-mercato/`,image:`/assets/images/portfolio/bottega-del-mercato.webp`,active:!0},{id:3,name:`Cento Cuori`,description:`Ristorante`,url:`https://robertogrilli.github.io/portfolio3-cento-cuori/`,image:`/assets/images/portfolio/cento-cuori.webp`,active:!0},{id:4,name:`Enoteca La Petite`,description:`Enoteca e wine bar`,url:`https://roberto-grilli-websites.github.io/mockup-enoteca-la-petite/`,image:`/assets/images/portfolio/enoteca-la-petite.webp`,active:!0},{id:5,name:`I Goliardi Roma`,description:`Ristorante · Roma`,url:`https://roberto-grilli-websites.github.io/mockup-i-goliardi-roma/`,image:`/assets/images/portfolio/i-goliardi-roma.webp`,active:!0}];function gv(){if(lv(hv),(0,Ec.default)({target:`[data-splitting]`,by:`chars`}),sessionStorage.getItem(`introSeen`)){_v(!0),K_(!1);return}document.body.classList.add(`intro-active`),W_(()=>{document.body.classList.remove(`intro-active`),sessionStorage.setItem(`introSeen`,`1`),K_(!1)})}function _v(e){let t=document.getElementById(`intro-overlay`);t&&t.remove();let n=document.getElementById(`navbar`);e?q.set(n,{y:0,opacity:1}):q.to(n,{y:0,opacity:1,duration:.6,ease:`power2.out`})}function vv(){document.querySelectorAll(`a[href^="#"]`).forEach(e=>{e.addEventListener(`click`,t=>{let n=document.querySelector(e.getAttribute(`href`));n&&(t.preventDefault(),q.to(window,{duration:1.2,scrollTo:{y:n,offsetY:80},ease:`power3.inOut`}),document.getElementById(`mobile-menu`).classList.contains(`is-open`)&&Sv())})})}var yv=!1,bv=null;function xv(){yv=!0;let e=document.getElementById(`mobile-menu`),t=e.querySelectorAll(`.mobile-link`),n=document.getElementById(`nav-hamburger`);e.classList.add(`is-open`),n.setAttribute(`aria-expanded`,`true`),document.body.style.overflow=`hidden`,bv=q.timeline(),bv.to(e,{clipPath:`circle(150% at calc(100% - 40px) 40px)`,duration:.7,ease:`power3.inOut`}).to(e.querySelector(`.mobile-links`),{opacity:1,duration:.1},`-=0.1`).to(t,{opacity:1,y:0,duration:.5,stagger:.08,ease:`power2.out`},`-=0.2`)}function Sv(){yv=!1;let e=document.getElementById(`mobile-menu`),t=e.querySelectorAll(`.mobile-link`);document.getElementById(`nav-hamburger`).setAttribute(`aria-expanded`,`false`),document.body.style.overflow=``,q.timeline({onComplete:()=>{e.classList.remove(`is-open`),q.set(t,{opacity:0,y:20}),q.set(e.querySelector(`.mobile-links`),{opacity:0})}}).to(e,{clipPath:`circle(0% at calc(100% - 40px) 40px)`,duration:.6,ease:`power3.inOut`})}function Cv(){let e=document.getElementById(`nav-hamburger`),t=document.getElementById(`mobile-menu-close`),n=document.querySelectorAll(`.mobile-link`);q.set(n,{opacity:0,y:20}),e.addEventListener(`click`,()=>{yv?Sv():xv()}),t.addEventListener(`click`,Sv),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&yv&&Sv()})}function wv(){let e=document.getElementById(`navbar`),t=[`#hero`,`#dolore-v2`,`#portfolio`,`#cta-finale`],n=[`#connessione`,`#come-funziona`,`#chi-sono`];function r(t){t===`dark`?(e.classList.add(`nav--dark`),e.classList.remove(`nav--light`)):(e.classList.add(`nav--light`),e.classList.remove(`nav--dark`))}let i=[...t,...n].map(e=>document.querySelector(e)).filter(Boolean),a=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.intersectionRatio>.3&&r(t.some(t=>document.querySelector(t)===e.target)?`dark`:`light`)})},{threshold:.3});i.forEach(e=>a.observe(e)),r(`dark`)}function Tv(){let e=document.querySelectorAll(`[data-mf-item]`);if(!e.length)return;e.forEach(e=>{let t=e.querySelector(`.mf-num`),n=e.querySelector(`.mf-body`),r=e.querySelector(`.mf-solution-wrap`);q.set(t,{scale:.85,opacity:0}),q.set(n,{y:50,opacity:0,filter:`blur(8px)`}),q.set(r,{height:0,opacity:0}),Y.create({trigger:e,start:`top 78%`,once:!0,onEnter:()=>{q.to(t,{scale:1,opacity:1,duration:1.4,ease:`power3.out`}),q.to(n,{y:0,opacity:1,filter:`blur(0px)`,duration:1,ease:`power2.out`,delay:.18})}}),Y.create({trigger:e,start:`top 38%`,once:!0,onEnter:()=>{q.to(r,{height:`auto`,opacity:1,duration:.7,ease:`power2.out`,delay:.05})}})});let t=document.querySelector(`[data-mf-header]`);if(t){let e=t.querySelector(`.mf-title`);e&&((0,Ec.default)({target:e,by:`words`}),e.querySelectorAll(`.word`).forEach(e=>{let t=document.createElement(`span`);t.className=`word-inner`,t.innerHTML=e.innerHTML,e.innerHTML=``,e.appendChild(t)}),q.set(e.querySelectorAll(`.word-inner`),{yPercent:110}),Y.create({trigger:t,start:`top 65%`,once:!0,onEnter:()=>{q.to(e.querySelectorAll(`.word-inner`),{yPercent:0,duration:.9,stagger:.07,ease:`power3.out`})}}))}let n=document.querySelector(`[data-mf-closing]`);n&&(q.set(n,{y:24,opacity:0}),Y.create({trigger:n,start:`top 85%`,once:!0,onEnter:()=>q.to(n,{y:0,opacity:1,duration:.9,ease:`power2.out`})})),e.forEach((t,n)=>{n<e.length-1&&q.to(t,{scale:.94,transformOrigin:`top center`,ease:`none`,scrollTrigger:{trigger:e[n+1],start:`top bottom`,end:`top top`,scrub:!0}})})}function Ev(){document.querySelectorAll(`[data-letter-reveal]`).forEach(e=>{let t=e.querySelectorAll(`.char`);t.length&&(q.set(t,{opacity:0,yPercent:80}),Y.create({trigger:e,start:`top 85%`,once:!0,onEnter:()=>{q.to(t,{opacity:1,yPercent:0,duration:.5,stagger:.07,ease:`power2.out`})}}))})}window.addEventListener(`beforeunload`,()=>{Y.killAll()}),document.addEventListener(`DOMContentLoaded`,()=>{document.body.classList.add(`gsap-active`),vv(),Cv(),wv(),gv(),Tv(),Ev(),fv()});