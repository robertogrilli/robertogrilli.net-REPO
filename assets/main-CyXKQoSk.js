...
void main() {
  ...
  `,t.appendChild(n),t.addEventListener(`keydown`,t=>{(t.key===`Enter`||t.key===` `)&&window.open(e.url,`_blank`,`noopener`)}),t}function dv(e){let t=document.createElement(`article`);t.className=`proj-card proj-card--placeholder`,t.setAttribute(`aria-hidden`,`true`);let n=`http://www.w3.org/2000/svg`,r=document.createElementNS(n,`svg`);r.setAttribute(`class`,`dashed-border`),r.style.cssText=`position:absolute;inset:0;width:100%;height:100%;pointer-events:none;`;let i=document.createElementNS(n,`rect`);i.setAttribute(`x`,`2`),i.setAttribute(`y`,`2`),i.setAttribute(`width`,`calc(100% - 4px)`),i.setAttribute(`height`,`calc(100% - 4px)`),i.setAttribute(`rx`,`4`),i.setAttribute(`fill`,`none`),i.setAttribute(`stroke`,`rgba(245,242,236,0.12)`),i.setAttribute(`stroke-width`,`1.5`),i.setAttribute(`stroke-dasharray`,`8 4`),r.appendChild(i),t.appendChild(r);let a=document.createElement(`div`);return a.style.cssText=`position:relative;z-index:1;text-align:center;`,a.innerHTML=`
    <span class="proj-placeholder-text">Prossimo progetto</span>
    <span class="proj-placeholder-year">2025 →</span>
  `,t.appendChild(a),t}function fv(){let e=[`Il tuo ristorante`,`La tua trattoria`,`La tua pizzeria`,`La tua caffetteria`],t=document.querySelector(`.hero-cycle-wrap`);if(!t)return;let n=t.querySelector(`.hero-cycle-word`),r=0,i=!1;function a(e){let t=document.createElement(`span`);t.style.cssText=`position:absolute;visibility:hidden;pointer-events:none;white-space:nowrap;`;let r=window.getComputedStyle(n);t.style.fontFamily=r.fontFamily,t.style.fontSize=r.fontSize,t.style.fontWeight=r.fontWeight,t.style.fontStyle=r.fontStyle,t.style.letterSpacing=r.letterSpacing,t.textContent=e,document.body.appendChild(t);let i=t.getBoundingClientRect().width;return document.body.removeChild(t),i}setTimeout(()=>{let n=a(e[0]);t.style.width=n+`px`},100),setTimeout(()=>{setInterval(()=>{if(i)return;i=!0;let o=(r+1)%e.length;n.classList.add(`hero-word-out`),setTimeout(()=>{r=o,n.textContent=e[r],n.classList.remove(`hero-word-out`),n.classList.add(`hero-word-in`);let s=a(e[r]);t.style.width=s+`px`,setTimeout(()=>{n.classList.remove(`hero-word-in`),i=!1},400)},300)},3e3)},2500)}var pv=`#version 300 es
precision mediump float;
...
}`;function yv(){let e=navigator.userAgent.toLowerCase();return e.includes(`safari`)&&!e.includes(`chrome`)&&!e.includes(`android`)}function bv(e){let t=visualViewport?.scale??1,n=visualViewport?.width??window.innerWidth,r=window.innerWidth-e.documentElement.clientWidth,i=t*n+r,a=outerWidth/i,o=Math.round(100*a);return o%5==0?o/100:o===33?1/3:o===67?2/3:o===133?4/3:a}var xv=`#version 300 es
precision mediump float;
...
`,Sv={simplex:1,warp:2,dots:3,wave:4,ripple:5,swirl:6,sphere:7},Cv={random:1,"2x2":2,"4x4":3,"8x8":4};function wv(e){if(Array.isArray(e))return e.length===4?e:e.length===3?[...e,1]:Av;if(typeof e!=`string`)return Av;let t,n,r,i=1;if(e.startsWith(`#`))[t,n,r,i]=Tv(e);else if(e.startsWith(`rgb`))[t,n,r,i]=Ev(e);else if(e.startsWith(`hsl`))[t,n,r,i]=Ov(Dv(e));else return console.error(`Unsupported color format`,e),Av;return[kv(t,0,1),kv(n,0,1),kv(r,0,1),kv(i,0,1)]}function Tv(e){return e=e.replace(/^#/,``),e.length===3&&(e=e.split(``).map(e=>e+e).join(``)),e.length===6&&(e+=`ff`),[parseInt(e.slice(0,2),16)/255,parseInt(e.slice(2,4),16)/255,parseInt(e.slice(4,6),16)/255,parseInt(e.slice(6,8),16)/255]}function Ev(e){let t=e.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i);return t?[parseInt(t[1]??`0`)/255,parseInt(t[2]??`0`)/255,parseInt(t[3]??`0`)/255,t[4]===void 0?1:parseFloat(t[4])]:[0,0,0,1]}function Dv(e){let t=e.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i);return t?[parseInt(t[1]??`0`),parseInt(t[2]??`0`),parseInt(t[3]??`0`),t[4]===void 0?1:parseFloat(t[4])]:[0,0,0,1]}function Ov(e){let[t,n,r,i]=e,a=t/360,o=n/100,s=r/100,c,l,u;if(n===0)c=l=u=s;else{let e=(e,t,n)=>(n<0&&(n+=1),n>1&&--n,n<1/6?e+(t-e)*6*n:n<1/2?t:n<2/3?e+(t-e)*(2/3-n)*6:e),t=s<.5?s*(1+o):s+o-s*o,n=2*s-t;c=e(n,t,a+1/3),l=e(n,t,a),u=e(n,t,a-1/3)}return[c,l,u,i]}var kv=(e,t,n)=>Math.min(Math.max(e,t),n),Av=[0,0,0,1];function jv(){let e=document.getElementById(`hero-dithering-host`);if(!e)return;let t={u_colorBack:wv(`#00000000`),u_colorFront:wv(`#C4622D`),u_shape:Sv.warp,u_type:Cv[`4x4`],u_pxSize:1.5},n;try{n=new hv(e,xv,t,void 0,.2,0,1)}catch(e){console.warn(`[hero-dithering] ShaderMount failed to initialize:`,e);return}let r=document.getElementById(`hero`);r&&(r.addEventListener(`mouseenter`,()=>n.setSpeed(.6)),r.addEventListener(`mouseleave`,()=>n.setSpeed(.2)))}function Mv(){let e=document.getElementById(`cta-dithering-host`);if(!e)return;let t={u_colorBack:wv(`#00000000`),u_colorFront:wv(`#C4622D`),u_shape:Sv.warp,u_type:Cv[`4x4`],u_pxSize:1.5},n;try{n=new hv(e,xv,t,void 0,.2,0,1)}catch(e){console.warn(`[cta-dithering] ShaderMount failed to initialize:`,e);return}let r=document.getElementById(`cta-card`);r&&(r.addEventListener(`mouseenter`,()=>n.setSpeed(.6)),r.addEventListener(`mouseleave`,()=>n.setSpeed(.2)))}q.registerPlugin(Y,oc,Tc),Y.config({ignoreMobileResize:!0}),window.addEventListener(`load`,()=>{document.fonts&&document.fonts.ready?document.fonts.ready.then(()=>Y.refresh()):setTimeout(()=>Y.refresh(),800)});function Nv(){document.querySelectorAll(`[data-scroll-reveal]`).forEach(e=>{let t=e.getBoundingClientRect();t.top<window.innerHeight*1.1&&t.bottom>0&&parseFloat(getComputedStyle(e).opacity)<.1&&q.to(e,{opacity:1,y:0,duration:.5,overwrite:`auto`})})}setTimeout(Nv,3e3);var Pv=!1;window.addEventListener(`scroll`,()=>{Pv||(Pv=!0,requestAnimationFrame(()=>{Pv=!1,Nv()}))},{passive:!0});var Fv=[{id:1,name:`Sicché — Roba Toscana`,description:`Street food toscano · Testaccio, Roma`,url:`[DA INSERIRE — URL del sito live]`,image:`[DA INSERIRE — screenshot del sito oppure foto del locale]`,active:!0},{id:2,name:`Da Oio a Casa Mia`,description:`Trattoria romana dal 1994 · Testaccio, Roma`,url:`[DA INSERIRE — URL del sito live]`,image:`[DA INSERIRE — screenshot del sito oppure foto del locale]`,active:!0},{id:3,active:!1},{id:4,active:!1},{id:5,active:!1}];function Iv(){if(lv(Fv),(0,Ec.default)({target:`[data-splitting]`,by:`chars`}),sessionStorage.getItem(`introSeen`)){Lv(!0),K_(!1);return}document.body.classList.add(`intro-active`),W_(()=>{document.body.classList.remove(`intro-active`),sessionStorage.setItem(`introSeen`,`1`),K_(!1)})}function Lv(e){let t=document.getElementById(`intro-overlay`);t&&t.remove();let n=document.getElementById(`navbar`);e?q.set(n,{y:0,opacity:1}):q.to(n,{y:0,opacity:1,duration:.6,ease:`power2.out`})}function Rv(){document.querySelectorAll(`a[href^="#"]`).forEach(e=>{e.addEventListener(`click`,t=>{let n=document.querySelector(e.getAttribute(`href`));n&&(t.preventDefault(),q.to(window,{duration:1.2,scrollTo:{y:n,offsetY:80},ease:`power3.inOut`}),document.getElementById(`mobile-menu`).classList.contains(`is-open`)&&Hv())})})}var zv=!1,Bv=null;function Vv(){zv=!0;let e=document.getElementById(`mobile-menu`),t=e.querySelectorAll(`.mobile-link`),n=document.getElementById(`nav-hamburger`);e.classList.add(`is-open`),n.setAttribute(`aria-expanded`,`true`),document.body.style.overflow=`hidden`,Bv=q.timeline(),Bv.to(e,{clipPath:`circle(150% at calc(100% - 40px) 40px)`,duration:.7,ease:`power3.inOut`}).to(e.querySelector(`.mobile-links`),{opacity:1,duration:.1},`-=0.1`).to(t,{opacity:1,y:0,duration:.5,stagger:.08,ease:`power2.out`},`-=0.2`)}function Hv(){zv=!1;let e=document.getElementById(`mobile-menu`),t=e.querySelectorAll(`.mobile-link`);document.getElementById(`nav-hamburger`).setAttribute(`aria-expanded`,`false`),document.body.style.overflow=``,q.timeline({onComplete:()=>{e.classList.remove(`is-open`),q.set(t,{opacity:0,y:20}),q.set(e.querySelector(`.mobile-links`),{opacity:0})}}).to(e,{clipPath:`circle(0% at calc(100% - 40px) 40px)`,duration:.6,ease:`power3.inOut`})}function Uv(){let e=document.getElementById(`nav-hamburger`),t=document.getElementById(`mobile-menu-close`),n=document.querySelectorAll(`.mobile-link`);q.set(n,{opacity:0,y:20}),e.addEventListener(`click`,()=>{zv?Hv():Vv()}),t.addEventListener(`click`,Hv),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&zv&&Hv()})}function Wv(){let e=document.getElementById(`navbar`),t=[`#hero`,`#dolore-v2`,`#portfolio`,`#cta-finale`],n=[`#connessione`,`#come-funziona`,`#chi-sono`];function r(t){t===`dark`?(e.classList.add(`nav--dark`),e.classList.remove(`nav--light`)):(e.classList.add(`nav--light`),e.classList.remove(`nav--dark`))}let i=[...t,...n].map(e=>document.querySelector(e)).filter(Boolean),a=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.intersectionRatio>.3&&r(t.some(t=>document.querySelector(t)===e.target)?`dark`:`light`)})},{threshold:.3});i.forEach(e=>a.observe(e)),r(`dark`)}function Gv(){let e=document.querySelectorAll(`[data-mf-item]`);if(!e.length)return;e.forEach(e=>{let t=e.querySelector(`.mf-num`),n=e.querySelector(`.mf-body`),r=e.querySelector(`.mf-solution-wrap`);q.set(t,{scale:.85,opacity:0}),q.set(n,{y:50,opacity:0,filter:`blur(8px)`}),q.set(r,{height:0,opacity:0}),Y.create({trigger:e,start:`top 78%`,once:!0,onEnter:()=>{q.to(t,{scale:1,opacity:1,duration:1.4,ease:`power3.out`}),q.to(n,{y:0,opacity:1,filter:`blur(0px)`,duration:1,ease:`power2.out`,delay:.18})}}),Y.create({trigger:e,start:`top 38%`,once:!0,onEnter:()=>{q.to(r,{height:`auto`,opacity:1,duration:.7,ease:`power2.out`,delay:.05})}})});let t=document.querySelector(`[data-mf-header]`);if(t){let e=t.querySelector(`.mf-title`);e&&((0,Ec.default)({target:e,by:`words`}),e.querySelectorAll(`.word`).forEach(e=>{let t=document.createElement(`span`);t.className=`word-inner`,t.innerHTML=e.innerHTML,e.innerHTML=``,e.appendChild(t)}),q.set(e.querySelectorAll(`.word-inner`),{yPercent:110}),Y.create({trigger:t,start:`top 65%`,once:!0,onEnter:()=>{q.to(e.querySelectorAll(`.word-inner`),{yPercent:0,duration:.9,stagger:.07,ease:`power3.out`})}}))}let n=document.querySelector(`[data-mf-closing]`);n&&(q.set(n,{y:24,opacity:0}),Y.create({trigger:n,start:`top 85%`,once:!0,onEnter:()=>q.to(n,{y:0,opacity:1,duration:.9,ease:`power2.out`})})),e.forEach((t,n)=>{n<e.length-1&&q.to(t,{scale:.94,transformOrigin:`top center`,ease:`none`,scrollTrigger:{trigger:e[n+1],start:`top bottom`,end:`top top`,scrub:!0}})})}function Kv(){document.querySelectorAll(`[data-letter-reveal]`).forEach(e=>{let t=e.querySelectorAll(`.char`);t.length&&(q.set(t,{opacity:0,yPercent:80}),Y.create({trigger:e,start:`top 85%`,once:!0,onEnter:()=>{q.to(t,{opacity:1,yPercent:0,duration:.5,stagger:.07,ease:`power2.out`})}}))})}window.addEventListener(`beforeunload`,()=>{Y.killAll()}),document.addEventListener(`DOMContentLoaded`,()=>{document.body.classList.add(`gsap-active`),Rv(),Uv(),Wv(),Iv(),Gv(),Kv(),fv(),jv(),Mv()});