...
void main() {
  ...
  `,t.appendChild(n),t.addEventListener(`keydown`,t=>{(t.key===`Enter`||t.key===` `)&&window.open(e.url,`_blank`,`noopener`)}),t}function lv(e){let t=document.createElement(`article`);t.className=`proj-card proj-card--placeholder`,t.setAttribute(`aria-hidden`,`true`);let n=`http://www.w3.org/2000/svg`,r=document.createElementNS(n,`svg`);r.setAttribute(`class`,`dashed-border`),r.style.cssText=`position:absolute;inset:0;width:100%;height:100%;pointer-events:none;`;let i=document.createElementNS(n,`rect`);i.setAttribute(`x`,`2`),i.setAttribute(`y`,`2`),i.setAttribute(`width`,`calc(100% - 4px)`),i.setAttribute(`height`,`calc(100% - 4px)`),i.setAttribute(`rx`,`4`),i.setAttribute(`fill`,`none`),i.setAttribute(`stroke`,`rgba(245,242,236,0.12)`),i.setAttribute(`stroke-width`,`1.5`),i.setAttribute(`stroke-dasharray`,`8 4`),r.appendChild(i),t.appendChild(r);let a=document.createElement(`div`);return a.style.cssText=`position:relative;z-index:1;text-align:center;`,a.innerHTML=`
    <span class="proj-placeholder-text">Prossimo progetto</span>
    <span class="proj-placeholder-year">2025 →</span>
  `,t.appendChild(a),t}q.registerPlugin(Y,oc,Tc),Y.config({ignoreMobileResize:!0}),window.addEventListener(`load`,()=>{document.fonts&&document.fonts.ready?document.fonts.ready.then(()=>Y.refresh()):setTimeout(()=>Y.refresh(),800)});function uv(){document.querySelectorAll(`[data-scroll-reveal]`).forEach(e=>{let t=e.getBoundingClientRect();t.top<window.innerHeight*1.1&&t.bottom>0&&parseFloat(getComputedStyle(e).opacity)<.1&&q.to(e,{opacity:1,y:0,duration:.5,overwrite:`auto`})})}setTimeout(uv,3e3);var dv=!1;window.addEventListener(`scroll`,()=>{dv||(dv=!0,requestAnimationFrame(()=>{dv=!1,uv()}))},{passive:!0});var fv=[{id:1,name:`Sicché — Roba Toscana`,description:`Street food toscano · Testaccio, Roma`,url:`[DA INSERIRE — URL del sito live]`,image:`[DA INSERIRE — screenshot del sito oppure foto del locale]`,active:!0},{id:2,name:`Da Oio a Casa Mia`,description:`Trattoria romana dal 1994 · Testaccio, Roma`,url:`[DA INSERIRE — URL del sito live]`,image:`[DA INSERIRE — screenshot del sito oppure foto del locale]`,active:!0},{id:3,active:!1},{id:4,active:!1},{id:5,active:!1}];function pv(){if(sv(fv),(0,Ec.default)({target:`[data-splitting]`,by:`chars`}),sessionStorage.getItem(`introSeen`)){mv(!0),K_(!1);return}document.body.classList.add(`intro-active`),W_(()=>{document.body.classList.remove(`intro-active`),sessionStorage.setItem(`introSeen`,`1`),K_(!1)})}function mv(e){let t=document.getElementById(`intro-overlay`);t&&t.remove();let n=document.getElementById(`navbar`);e?q.set(n,{y:0,opacity:1}):q.to(n,{y:0,opacity:1,duration:.6,ease:`power2.out`})}function hv(){document.querySelectorAll(`a[href^="#"]`).forEach(e=>{e.addEventListener(`click`,t=>{let n=document.querySelector(e.getAttribute(`href`));n&&(t.preventDefault(),q.to(window,{duration:1.2,scrollTo:{y:n,offsetY:80},ease:`power3.inOut`}),document.getElementById(`mobile-menu`).classList.contains(`is-open`)&&yv())})})}var gv=!1,_v=null;function vv(){gv=!0;let e=document.getElementById(`mobile-menu`),t=e.querySelectorAll(`.mobile-link`),n=document.getElementById(`nav-hamburger`);e.classList.add(`is-open`),n.setAttribute(`aria-expanded`,`true`),document.body.style.overflow=`hidden`,_v=q.timeline(),_v.to(e,{clipPath:`circle(150% at calc(100% - 40px) 40px)`,duration:.7,ease:`power3.inOut`}).to(e.querySelector(`.mobile-links`),{opacity:1,duration:.1},`-=0.1`).to(t,{opacity:1,y:0,duration:.5,stagger:.08,ease:`power2.out`},`-=0.2`)}function yv(){gv=!1;let e=document.getElementById(`mobile-menu`),t=e.querySelectorAll(`.mobile-link`);document.getElementById(`nav-hamburger`).setAttribute(`aria-expanded`,`false`),document.body.style.overflow=``,q.timeline({onComplete:()=>{e.classList.remove(`is-open`),q.set(t,{opacity:0,y:20}),q.set(e.querySelector(`.mobile-links`),{opacity:0})}}).to(e,{clipPath:`circle(0% at calc(100% - 40px) 40px)`,duration:.6,ease:`power3.inOut`})}function bv(){let e=document.getElementById(`nav-hamburger`),t=document.getElementById(`mobile-menu-close`),n=document.querySelectorAll(`.mobile-link`);q.set(n,{opacity:0,y:20}),e.addEventListener(`click`,()=>{gv?yv():vv()}),t.addEventListener(`click`,yv),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&gv&&yv()})}function xv(){let e=document.getElementById(`navbar`),t=[`#hero`,`#portfolio`,`#cta-finale`],n=[`#connessione`,`#dolore`,`#come-funziona`,`#chi-sono`];function r(t){t===`dark`?(e.classList.add(`nav--dark`),e.classList.remove(`nav--light`)):(e.classList.add(`nav--light`),e.classList.remove(`nav--dark`))}let i=[...t,...n].map(e=>document.querySelector(e)).filter(Boolean),a=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.intersectionRatio>.3&&r(t.some(t=>document.querySelector(t)===e.target)?`dark`:`light`)})},{threshold:.3});i.forEach(e=>a.observe(e)),r(`dark`)}window.addEventListener(`beforeunload`,()=>{Y.killAll()}),document.addEventListener(`DOMContentLoaded`,()=>{document.body.classList.add(`gsap-active`),hv(),bv(),xv(),pv()});